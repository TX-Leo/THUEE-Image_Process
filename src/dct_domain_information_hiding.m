function dct_domain_information_hiding(image_src,JpegCoeff_src)
    ...
    %load('image.mat');
    % DCT域信息隐藏技术
    my_dct_domain_information_hiding_technology(image,DCTAB, ACTAB, QTAB);
end
% DCT域信息隐藏技术
function my_dct_domain_information_hiding_technology(image,DCTAB, ACTAB, QTAB)
    ...
    info1 = randi([0, 1], size(C_tilde, 1), size(C_tilde, 2));% 315
