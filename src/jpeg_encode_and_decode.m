function [image,image_res] = jpeg_encode_and_decode(image_src,JpegCoeff_src)
    ...
    %load('image.mat');
    image_res = my_process_image(image,DCTAB, ACTAB, QTAB);
    subplot(1,2,1);
    imshow(image);
    title('original image');
    subplot(1,2,2);
    imshow(image_res);
    title('image after jpeg encode and decode');
end
